...
Descoberta e Estudo: Fãs e pesquisadores podem filtrar referências por Status de Validação ('Validada' ou 'Em Discussão') e, crucialmente, acessar links diretos (Spotify, YouTube, etc.) para comparar o trecho do filme com a inspiração original imediatamente.
